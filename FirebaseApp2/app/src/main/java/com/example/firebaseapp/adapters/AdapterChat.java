    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, final int i) {
        ...
        myHolder.messageLAyout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle(v.getContext().getResources().getString(R.string.Delete));
                builder.setMessage(v.getContext().getResources().getString(R.string.confirm_delete));
                //delete button
        ...
        if (i==chatList.size()-1){
            if (chatList.get(i).isSeen()){
                myHolder.isSeenTv.setText(R.string.seen);
            }
            else {
                myHolder.isSeenTv.setText(R.string.delivered_success);
            }
        }
        else {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()){
                    ...
                    if (ds.child("sender").getValue().equals(myUID)){
                       //1) Remove the message from Chats"
                        ...
                        hashMap.put("message", R.string.message_was_deleted);
