...
import static com.example.firebaseapp.R.string.edit_cover;
import static com.example.firebaseapp.R.string.edit_name;
import static com.example.firebaseapp.R.string.edit_password;
import static com.example.firebaseapp.R.string.edit_profile;
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which == 0) {
                    ...
                    pd.setMessage(Objects.requireNonNull(getView()).getResources().getString(R.string.update_profile));
                    profileOrCoverPhoto = "image"; //i.e. changing profile picture, make sure to assign same value
                    showImagePicDialog();
                } else if (which == 1) {
                    //Edit Cover clicked
                    pd.setMessage(Objects.requireNonNull(getView()).getResources().getString(R.string.update_cover));
                    profileOrCoverPhoto = "cover"; //i.e. changing cover photo, make sure to assign same value
                    showImagePicDialog();
                } else if (which == 2) {
                    //Edit Name clicked
                    pd.setMessage(Objects.requireNonNull(getView()).getResources().getString(R.string.update_name));
                    ...
                    pd.setMessage(Objects.requireNonNull(getView()).getResources().getString(R.string.updating_password));
