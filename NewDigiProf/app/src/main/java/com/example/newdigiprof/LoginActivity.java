                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // If user is signing in first time then get and show the user info from google account
                            if(task.getResult().getAdditionalUserInfo().isNewUser()){
                                ...
                                hashMap.put("uid", uid);
                                hashMap.put("name", "");// will implement in next version
                                hashMap.put("image", "");
                                hashMap.put("cover", "");
